...
export function LoginForm() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (error) {
        // Provide helpful messaging for invalid credentials
        if (error.message.toLowerCase().includes('invalid login credentials') || 
            error.message.toLowerCase().includes('invalid email or password')) {
          setError(
            "Invalid email or password. If you signed up using Google or another social provider, " +
            "please use the 'Continue with Google' button below instead of entering a password."
          );
        } else {
